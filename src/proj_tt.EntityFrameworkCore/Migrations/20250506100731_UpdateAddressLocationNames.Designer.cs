...
namespace proj_tt.Migrations
{
    ...
    [Migration("20250506100731_UpdateAddressLocationNames")]
    partial class UpdateAddressLocationNames
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("proj_tt.Addresses.Address", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("proj_tt.Carts.Cart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("proj_tt.Carts.CartItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("proj_tt.Orders.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("proj_tt.Orders.OrderItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("proj_tt.Addresses.Address", b =>
                {
                    b.HasOne("proj_tt.Authorization.Users.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("proj_tt.Carts.CartItem", b =>
                {
                    b.HasOne("proj_tt.Carts.Cart", "Cart")
                        .WithMany("CartItems")
                        .HasForeignKey("CartId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("proj_tt.Products.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("proj_tt.Orders.Order", b =>
                {
                    b.HasOne("proj_tt.Addresses.Address", "DeliveryAddress")
                        .WithMany()
            ...
            modelBuilder.Entity("proj_tt.Orders.OrderItem", b =>
                {
                    b.HasOne("proj_tt.Orders.Order", "Order")
                        .WithMany("OrderItems")
