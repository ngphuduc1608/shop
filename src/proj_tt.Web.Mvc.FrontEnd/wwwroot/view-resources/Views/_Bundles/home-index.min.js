        ...
        <div class="box position-relative">
            ...
            <div class="product-description">
                ...
                <div class="price-info">
                    <span class="current-price">$${(n.price*(1-n.discount/100)).toFixed(2)} USD</span>
                    <span class="original-price">$${n.price} USD</span>
                </div>
            </div>
        </div>
    </a>
</div>`});n(".product-list").html(i)}).fail(function(n){console.error("Failed to load products:",n)})}function r(){n.ajax({url:abp.appPath+"api/services/app/Banner/GetListBanner",method:"GET",success:function(t){const i=t.result.filter(n=>n.isActive),r=i.map(n=>`
                    <li class="swiper-slide">
                        <a href="${n.link}">
                            <img src="${n.imageUrl}" alt="${n.title}">
                        </a>
                    </li>
                `).join("");n("#banner-list").html(r);var u=new Swiper("#top-slide-banners",{slidesPerView:1,spaceBetween:30,loop:!0,autoplay:{delay:5e3,disableOnInteraction:!1},pagination:{el:"#top-slide-banners .swiper-pagination",clickable:!0},navigation:{nextEl:"#top-slide-banners .swiper-button-next",prevEl:"#top-slide-banners .swiper-button-prev"}})},error:function(){}})}var t=abp.services.app.product,u=abp.localization.getSource("proj_tt");n(function(){i();r()})}(jQuery);